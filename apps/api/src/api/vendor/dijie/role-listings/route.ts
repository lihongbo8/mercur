...
function isRoleListingStore(value: unknown): value is DijieRoleListingStore {
  return (
    value !== null &&
    typeof value === "object" &&
    typeof (value as { createDijieRoleListing?: unknown }).createDijieRoleListing ===
      "function"
  );
}
...
export async function POST(req: MedusaRequest, res: MedusaResponse) {
  ...
  const packageId = stringField(body, "packageId") ?? stringField(body, "package_id");
